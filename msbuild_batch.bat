...
xcopy Log4ALA\*.nupkg D:\produkte\dave\tools\NuPackageServer\Packages    /S /E /Y

REM restart project e.g. dave or metrics and rebuild to get the new Log4ALA nuget package

"C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\MSBuild\15.0\Bin\MSBuild.exe" BuildProject.proj /p:Configuration="net45;net452;net46;net461" /p:Targets="clean;build"
cd Log4ALA
